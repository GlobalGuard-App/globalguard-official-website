...
const sections = [
  ...
  { title: 'Governing Law', content: 'These terms are governed by California law. Disputes shall be resolved through binding arbitration in San Francisco, CA, except where prohibited by law.' },
];

export default function Terms() {
  return (
    <PageLayout>
      <SEO title="Terms of Service — GlobalGuard" description="GlobalGuard Terms of Service and user agreement." />
      <section className="pt-32 pb-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader badge="Legal" title="Terms of Service" subtitle="Last updated: June 5, 2026" />
